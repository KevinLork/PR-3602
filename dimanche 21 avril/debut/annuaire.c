...
AnnuaireClients* nouvelAnnuaire(int nbClients)
  /*****************************************************************/
  /* Alloue la mémoire pour un annuaire pouvant contenir nbClients */
  /*****************************************************************/
{
...
void libererAnnuaire(AnnuaireClients* an)
  /*****************************************************************/
  /* Libère la mémoire réservée pour un annuaire                   */
  /*****************************************************************/
{
  free(an->donnees);
  free(an);
...
AnnuaireClients *annuaireAleatoire(int nbBanques, int nbClients)
  /*****************************************************************/
  /* Retourne un annuaire généré aléatoirement contenant nbClients */
  /* répartis dans nbBanques, numérotées de 0 à nbBanques - 1      */
  /*****************************************************************/
{
...
void afficherAnnuaire(AnnuaireClients *an)
  /*****************************************************************/
  /* Affiche à l'écran l'annuaire an                               */ 
  /*****************************************************************/
{
  int i;
  char * ligne;
...
int sauvegardeAnnuaire(AnnuaireClients *an, char *fileName)
  /*****************************************************************/
  /* Sauvegarde l'annuaire an dans le fichier nommé fileName       */
  /* Retourne 1 en cas de succès et 0 en cas d'échec (le fichier   */
...
AnnuaireClients *annuaire(char *fileName)
  /*****************************************************************/
  /* Retourne l'annuaire stocké dans le fichier filName            */
  /*****************************************************************/
{
...
AnnuaireClients* annuaireFiltre(AnnuaireClients *anComplet, char *codeBanque)
  /*****************************************************************/
  /* Retourne un nouvel annuaire qui contient toutes les entrées   */
...
Client *client(AnnuaireClients* an, char* cb)
  ...
  /* carte est cb. Si l'annuaire ne contient pas de client dont la */
  /* carte est cb, alors NULL est retourné.                        */
  /*****************************************************************/
{
  int i;
